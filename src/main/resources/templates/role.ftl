	...
	<div id="page-content">
		<div class="panel">
			<div id="toolbar" class="table-toolbar-left">
				<button class="btn btn-primary" onclick="roleModal(0)"><i class="ion-plus"></i> 新增</button>
				<button class="btn btn-mint" onclick="roleModal(1)"><i class="ion-edit"></i> 修改</button>
				<button class="btn btn-danger" onclick="delRole()"><i class="ion-close"></i> 删除</button>
				<button onclick="menuModal()" class="btn"><i class="ion-gear-b"></i> 配置菜单</button>
                ...
                <form id="addForm" method="post" class="form-horizontal">
	                ...
	                <div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
					            <textarea rows="3" class="form-control" name="description" placeholder="角色描述" id="roleDes"></textarea>
							</div>
						</div>
	                </div>
