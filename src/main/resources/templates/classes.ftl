...
<body>
				...
				<div class=" fixed-table-toolbar">
					<div class="bars pull-left">
						<div id="toolbar" class="table-toolbar-left">
							<button onclick="classModal(0)" class="btn btn-primary"><i class="ion-plus"></i> 新增</button>
							<button onclick="classModal(1)"class="btn btn-mint"><i class="ion-edit"></i> 修改</button>
							<button class="btn btn-danger" onclick="delClass()"><i class="ion-close"></i> 删除</button>
    ...
    <div class="modal fade" id="classModal" role="dialog" tabindex="-1" data-backdrop="static" aria-labelledby="classModal" aria-hidden="true">
                ...
                <form id="addForm" method="post" class="form-horizontal">
                	...
                	<div class="modal-body">
						<div class="form-group">
							...
							<div class="col-lg-7">
                                <input name="parentclassid" id="classSelect" type="text" class="form-control" placeholder="父分类编号" />   
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<input multiple type="file" data-show-caption="true" class="form-control" name="file" placeholder="上传分类图片" id="file"/>
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<textarea class="form-control" name="classdescription" placeholder="分类简介" id="classDescription"></textarea>
							</div>
						</div>
						<div class="form-group">
