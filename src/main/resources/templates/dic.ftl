...
<body>
		...
		<div class="panel">
			<div id="dicToolbar" class="table-toolbar-left">
				...
				<div style="float:left;margin-left:10px;">
					<button onclick="dicTypeModal()" class="btn btn-primary"><i class="ion-plus"></i> 新增字典类型</button>
					<button class="btn btn-danger" onclick="delDicTypeBtn()"><i class="ion-close"></i> 删除字典类型</button>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button onclick="dicModal(0)" class="btn btn-primary"><i class="ion-plus"></i> 新增字典</button>
					<button class="btn btn-mint" onclick="dicModal(1)"><i class="ion-edit"></i> 修改字典</button>
					<button class="btn btn-danger" onclick="delDics()"><i class="ion-close"></i> 删除字典</button>
	...
	<!--addDicTypeModal-->
    <div class="modal fade" id="addDicTypeModal" role="dialog" tabindex="-1" aria-labelledby="addDicModal" aria-hidden="true">
